...
namespace ColorStatistics
{
    public partial class FrmBlue : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            t = new Thread(new ThreadStart(A));
            tCount = new Thread(new ThreadStart(ACount));
            t.Start();
            tCount.Start(); 
        }
        ...
        private   void A()
        {
            string paths =   ConfigurationManager.AppSettings["imgpath"].ToString();//ConfigurationManager.ConnectionStrings["blue"].ConnectionString;
            string isLog = ConfigurationManager.AppSettings["IsLog"].ToString();
            while (isRun)
            {
                Thread.Sleep(100);
                DataSet DS = DbHelperSQL.ExecuteDataset(CommandType.Text, "SELECT * FROM [PictureMainInformation] WHERE BlueValue=0 ");
                string sqlupdate = "";
                if (DS.Tables.Count > 0)
                {
                    ...
                    if (dtimg.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow drr in dtimg.Rows)
                        {
                            List<Statistics.MajorColor> MCc;
                            int PixelAmount = 0;
                            try
                            {

                                #region
                                MCc = Statistics.PrincipalColorAnalysis((Bitmap)Bitmap.FromFile(paths + drr["str2"]), 20, 24);
                                if (MCc != null)
                                {
                                    dt = new DataTable();
                                    DataColumn dc = new DataColumn("a");
                                    ...
                                    for (int i = 0; i < MCc.Count; i++)
                                    {
                                        DataRow dr = dt.NewRow();
                                        dr["a"] = i;
                                        dr["颜色"] = IntToColor(MCc[i].Color);
                                        dr["百分比"] = (double)MCc[i].Amount / PixelAmount;
                                        dr["数量"] = MCc[i].Amount;
                                        dr["RGB"] = IntToColorValue(MCc[i].Color);
                                        string[] DD = IntToColorValueCCC(MCc[i].Color).Split(',');
                                        dr["RGB灰度值"] = DD[0];
                                        dr["R减G"] = DD[1];
                                        dr["R减B"] = DD[2];
                                        dr["G减B"] = DD[3];
                                    ...
                                    if (dt.Rows.Count > 0)
                                    {
                                        int bluevalue = BlueScore(dt);
                                        if (bluevalue == 0)
                                        { bluevalue = 1; }
                                        sqlupdate += "update PictureMainInformation set BlueValue=" + bluevalue + " where ID='" + drr["ID"] + "'; ";
                                    }
                                    else
                                    {
                                         
                                        sqlupdate += "update PictureMainInformation set BlueValue=1    where ID='" + drr["ID"] + "'; ";
                                    }
                                    //if (dt.Rows.Count > 0)
                                    //{
                                    //    int ss = Convert.ToInt32(dt.Rows[0]["色相"]);
                                    //    int bluevalue = 1;
                                    //    if (ss >= 220)
                                    //    {
                                    //        bluevalue = 100;
                                    //    }
                                    //    else if (ss < 220&&ss>=210)
                                    //    {
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(95, 99); 
                                    //    }
                                    //    else if (ss < 210 && ss >= 200)
                                    //    {
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(90, 94);
                                    //    }
                                    //    else if (ss < 200 && ss >= 190)
                                    //    {
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(85, 89);
                                    //    }
                                    //    else if (ss < 190 && ss >= 180)
                                    //    {
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(80, 84);
                                    //    }
                                    //    else if (ss < 180 && ss >= 170)
                                    //    {
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(75, 79);
                                    //    }
                                    //    else if (ss < 170 && ss >= 160)
                                    //    {
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(70, 74);
                                    //    }
                                    //    else if (ss < 160 && ss >= 150)
                                    //    {
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(65, 59);
                                    //    }
                                    //    else if (ss < 150 && ss >= 140)
                                    //    {
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(60, 64);
                                    //    }
                                    //    else if (ss < 140 && ss >= 130)
                                    //    {
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(55, 59);
                                    //    }
                                    //    else if (ss < 130 && ss >= 120)
                                    //    {
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(50, 54);
                                    //    }
                                    //    else if (ss < 120 && ss >= 110)
                                    //    {
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(45, 49);
                                    //    }
                                    //    else if (ss < 110 && ss >= 100)
                                    //    {
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(40, 44);
                                    //    }
                                    //    else if (ss < 100 && ss >= 90)
                                    //    {
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(35, 39);
                                    //    }
                                    //    else if (ss < 90 && ss >= 80)
                                    //    {
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(30, 34);
                                    //    }
                                    //    else if (ss < 80 && ss >= 70)
                                    //    {
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(25, 29);
                                    //    }
                                    //    else if (ss < 70 && ss >= 60)
                                    //    {
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(20, 24);
                                    //    }
                                    //    else
                                    //    { 
                                    //        Random rd = new Random();

                                    //        bluevalue = rd.Next(1, 19);
                                    ...
                                    //    sqlupdate += "update PictureMainInformation set BlueValue=" + rd.Next(1, 19) + " where ID='" + drr["ID"] + "'; ";
                                    //}
                            ...
                            {
                                NetLog.WriteTextLog("log:", ex.ToString(), DateTime.Now);
                            }
                        }
                        if (isLog=="true")
                        { 
                        NetLog.WriteTextLog("log:", sqlupdate, DateTime.Now);
                        }
                        DbHelperSQL.ExecuteNonQuery(CommandType.Text, sqlupdate);
              ...
              string sqlupdateRenqi = "";
                if (DS.Tables.Count > 0)
                {
                    ...
                    if (dtimg.Rows.Count > 0)
                    {
                         foreach (DataRow drr in dtimg.Rows)
                        {
                            sqlupdateZan += string.Format(@" update [UserInformations] set int1=(
  select sum(ReviewVolume) zan   from [PictureInformation] where  PictureID in(
 select id from [PictureMainInformation] where UserID='{0}')
 )
 where id='{0}';",drr["id"]);

                            //我的粉丝  别人关注了我，就是我的粉丝  也就是说picid=我的用户id
                            sqlupdateMess += string.Format(@" 
  update [UserInformations] set int2=(
   select count(picid) from OptionInfo 
 where picid='{0}'  and types=3 
 )
 where id='{0}';", drr["id"]);
                            //关注，我关注了那些图片   也就说userid=我的用户id
                            sqlupdateRenqi += string.Format(@" 
  update [UserInformations] set int3=(
   select count(userid) from OptionInfo 
 where userid='{0}'  and types=3 
 )
 where id='{0}';", drr["id"]);
                         ...
                         if (isLog == "true")
                         {
                             NetLog.WriteTextLog("sqlupdateZan:", sqlupdateZan, DateTime.Now);
                             NetLog.WriteTextLog("sqlupdateMess:", sqlupdateMess, DateTime.Now);
                             NetLog.WriteTextLog("sqlupdateRenqi:", sqlupdateRenqi, DateTime.Now);
                         }
                         try
                         {
                             DbHelperSQL.ExecuteNonQuery(CommandType.Text, sqlupdateZan);
                             DbHelperSQL.ExecuteNonQuery(CommandType.Text, sqlupdateMess);
                             DbHelperSQL.ExecuteNonQuery(CommandType.Text, sqlupdateRenqi);
                         }
                         catch (Exception ex)
                         {
                             NetLog.WriteTextLog("ACount-log:", ex.ToString(), DateTime.Now);
                         }
                ...
                DS = DbHelperSQL.ExecuteDataset(CommandType.Text, "SELECT id FROM PictureMainInformation   ");
                ...
                if (DS.Tables.Count > 0)
                {
                    ...
                    if (dtimg.Rows.Count > 0)
                    {
                        foreach (DataRow drr in dtimg.Rows)
                        {
                            sqlupdateZan += string.Format(@" update [PictureMainInformation] set int1=(
   select sum(ReviewVolume)  from [dbo].[PictureInformation]  where PictureID='{0}'
 )
 where id='{0}';", drr["id"]);

                            
                            sqlupdateMess += string.Format(@" 
  update [PictureMainInformation] set int2=(
  select sum(ReviewInforNumber) from [dbo].[PictureInformation]  where PictureID='{0}'
 )
 where id='{0}';", drr["id"]);
                        ...
                        if (isLog == "true")
                        {
                            ...
                            NetLog.WriteTextLog("单组sqlupdateMess:", sqlupdateMess, DateTime.Now);
                            NetLog.WriteTextLog("单组sqlupdateZan:", sqlupdateZan, DateTime.Now);
                        }
                        try
                        {
                            DbHelperSQL.ExecuteNonQuery(CommandType.Text, sqlupdateZan);
                        ...
                        {
                            NetLog.WriteTextLog("ACount单组-log:", ex.ToString(), DateTime.Now);
                        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                NetLog.WriteTextLog("log-t.Abort:", ex.ToString(), DateTime.Now);
